...
import poppy
from poppy.logger import RollbarHandler
...
class LogHandlerTest(BaseTest):
    ...
    def test_request_is_get_from_log_record_if_present(self):
        ...
        # just need to be sure that proper poppy function is called
        # with passed request as argument.
        with mock.patch("poppy.report_message") as report_message_mock:
        ...
        if not sys.version_info[:2] == (2, 6):
            ...
            # won't have any
            with mock.patch("poppy.report_exc_info") as report_exc_info:
                with mock.patch("poppy.report_message") as report_message_mock:
