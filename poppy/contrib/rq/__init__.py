...
def exception_handler(job, *exc_info):
    ...
    NOTE: Make sure that in your RQ worker process, poppy.init() has been called with
    ...
    poppy.report_exc_info(exc_info, extra_data=extra_data, payload_data=payload_data)
